...
@Component({
  selector: 'app-fr-onsite-details',
  templateUrl: './fr-onsite-details.component.html',
  styleUrl: './fr-onsite-details.component.scss'
})
export class FrOnsiteDetailsComponent {
