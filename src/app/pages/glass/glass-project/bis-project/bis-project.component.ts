...
import {CreatebisComponent} from "./createbis/createbis.component";
import {EditbisComponent} from "./editbis/editbis.component";

@Component({
  selector: 'app-bis-project',
  templateUrl: './bis-project.component.html',
  styleUrl: './bis-project.component.scss'
})
export class BisProjectComponent {
  ...
  openPopupForms(): void {
    ...
    const modalRef = this.modalService.open(CreatebisComponent, { centered: true,size: 'lg'});

  }
  openEditForm(){
    const modalRef = this.modalService.open(EditbisComponent, { centered: true,size: 'lg'});
  }
